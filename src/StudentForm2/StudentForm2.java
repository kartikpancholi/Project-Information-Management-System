...
public class StudentForm2 implements Initializable  {
    ...
    public void initialize(URL location, ResourceBundle resources)
    {
        ...
        guide.setItems(db.getGuides(true));
    ...
    public void onSubmit()
    {
        ...
        Global.openPage(this, "../StudentHome/StudentHome.fxml", "Project Home - Faculty");
